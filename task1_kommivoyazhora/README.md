...
1. [Описание](#описание)
2. [Результаты работы программы](#результаты-работы-программы)
   - [Базовый диапазон стоимостей (до 100)](#1-базовый-диапазон-стоимостей-до-100)
   - [Большой диапазон стоимостей (до 10 000)](#2-большой-диапазон-стоимостей-до-10-000)
3. [Выводы](#выводы)
